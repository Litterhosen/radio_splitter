...
MyTrack.mp3,Artist-Title__0001__152bpm__16bar__hold_on__abc123_tail.mp3,1,45.2,70.5,25.3,152,16,Hold on I'm coming to get you,music,0.82,Song Hunter | Broadcast Hunter,music,0.82,en,0.8,hold on i'm coming,musik|hook|16bar,THEME:TIME
MyTrack.mp3,Artist-Title__0002__152bpm__16bar__noslug__def456_tail.mp3,2,120.0,145.3,25.3,152,16,,music,0.82,Song Hunter | Broadcast Hunter,music,0.82,unknown,0.0,,musik|hook|16bar,
```
...
RadioShow.mp3,Host - Morning_Show__0001__00-02-15__velkommen__xyz789.mp3,1,135.4,142.8,7.4,Velkommen til morgen programmet,mixed,0.68,Broadcast Hunter | Song Hunter,mixed,0.68,da,0.8,velkommen til morgen programmet,radio/nyheder,THEME:META,0.15
RadioShow.mp3,Host - Morning_Show__0002__00-02-45__breaking_news__uvw123.mp3,2,165.2,178.9,13.7,Breaking news just in from downtown,mixed,0.68,Broadcast Hunter | Song Hunter,mixed,0.68,en,0.8,breaking news just in from,radio/nyheder,THEME:META,0.25
```
...
- `language_guess_file`: Detected from overall audio content (uses same value as audio_type_guess in current implementation)
- `language_guess_clip`: Detected from individual clip transcription via Whisper
- Clips can have different languages than the source file
